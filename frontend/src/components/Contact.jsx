        ...
        <footer data-theme-trigger="light" style={{ background: 'transparent', position: 'relative', overflow: 'hidden', paddingTop: '8vh' }}>
            ...
            <div style={{
                ...
                <div style={{ display: 'flex', gap: '1.5rem' }}>
                    <a href="/privacy-policy" style={{ color: '#666', textDecoration: 'none', borderBottom: '1px solid transparent', transition: 'border-color 0.3s' }} onMouseEnter={(e) => e.target.style.borderBottom = '1px solid #666'} onMouseLeave={(e) => e.target.style.borderBottom = '1px solid transparent'}>Privacy Policy</a>
                </div>
            </div>
        </footer>
    );
